      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-12 mb-3">
            <div class="product-thumb">
              ...
              <div class="product-info d-flex">
                <div>
                  <h5 class="product-title mb-0">
                    <a href="#" class="product-title-link">Package</a>
                  </h5>
          ...
          <div class="col-lg-4 col-12 mb-3">
            <div class="product-thumb">
              <a href="#">
                <img src="images/product/quokkabottles-kFc1_G1GvKA-unsplash.jpeg" class="img-fluid product-image"
                  alt="">
              </a>
              ...
              <div class="product-info d-flex">
                <div>
                  <h5 class="product-title mb-0">
                    <a href="#" class="product-title-link">Bottle</a>
                  </h5>
          ...
          <div class="col-lg-4 col-12 mb-3">
            <div class="product-thumb">
              ...
              <div class="product-info d-flex">
                <div>
                  <h5 class="product-title mb-0">
                    <a href="#" class="product-title-link">Medicine</a>
                  </h5>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-10 me-auto mb-4">
          <h4 class="text-white mb-3"><a href="index.php">SAP</a> Fashion</h4>
