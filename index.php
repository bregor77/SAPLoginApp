...
<body>
  ...
  <main>
    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        ...
        <a class="navbar-brand" href="index.php">
          <strong><span>SAP</span> Project</strong>
        </a>
    ...
    <section class="slick-slideshow">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 col-10">
                ...
                <p class="lead text-white mt-lg-3 mb-lg-5">SAP Project</p>
      ...
      <div class="slick-custom">
        <img src="images/slideshow/two-business-partners-working-together-office-computer.jpeg" class="img-fluid"
          alt="">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 col-10">
                ...
                <p class="lead text-white mt-lg-3 mb-lg-5">HTML CSS template websites for everyone.</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 text-center">
            <h2 class="mb-5">Get started with <span>SAP</span> Project</h2>
          </div>
            ...
            <ul class="nav nav-pills mb-5 mx-auto justify-content-center align-items-center" id="pills-tab"
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                  type="button" role="tab" aria-controls="pills-home" aria-selected="true">Introduction</button>
              </li>

              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-youtube-tab" data-bs-toggle="pill" data-bs-target="#pills-youtube"
                  type="button" role="tab" aria-controls="pills-youtube" aria-selected="true">How we work?</button>
              </li>

              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-skill-tab" data-bs-toggle="pill" data-bs-target="#pills-skill"
                  type="button" role="tab" aria-controls="pills-skill" aria-selected="false">Capabilites</button>
              </li>
            </ul>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 col-12">
                    <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                      ...
                      <p>SAP Project <a href="login.php">login</a> / <a
                          href="registration.php">create an account</a> pages, product listing / product detail, about, FAQs, and
                        contact page.</p>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 col-12">
                    <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                      ...
                      <p>Over three years in business, We’ve had the chance to work on a variety of projects, with
                        companies</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 col-12">
            <div class="px-5 py-5 py-lg-0">
              ...
              <p class="lead mb-4">SAP Project</p>
